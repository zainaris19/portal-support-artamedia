  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-2">
        <SummaryCard icon={Server} label="Total Device" value={summary?.total} loading={loadingSummary} />
        <SummaryCard icon={CheckCircle2} label="Online" value={summary?.online} loading={loadingSummary} tone="emerald" />
        <SummaryCard icon={AlertTriangle} label="Warning" value={summary?.warning} loading={loadingSummary} tone="amber" />
        <SummaryCard icon={XCircle} label="Offline" value={summary?.offline} loading={loadingSummary} tone="rose" />
        <SummaryCard icon={Activity} label="Fault" value={summary?.fault} loading={loadingSummary} tone="rose" />
        <SummaryCard icon={Signal} label="Poor Optical" value={summary?.poor_optical} loading={loadingSummary} tone="amber" />
        <SummaryCard icon={Wifi} label="Total WiFi Client" value={summary?.total_wifi_client} loading={loadingSummary} tone="sky" />
      </div>
