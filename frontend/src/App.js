...
import TicketHistory from '@/pages/crm/TicketHistory';
...
import OLTManagement from '@/pages/network/OLTManagement';
import OLTDetail from '@/pages/network/OLTDetail';
import OLTSettings from '@/pages/settings/OLTSettings';
          ...
          <CountsProvider>
            <Routes>
              ...
              >
                ...
                <Route path="crm/ticket/:id/history" element={<TicketHistory />} />
                ...
                <Route path="network/olt" element={<OLTManagement />} />
                <Route path="network/olt/:oltId" element={<OLTDetail />} />
                ...
                <Route path="settings/integrations/olt" element={<OLTSettings />} />
