...
async def on_startup():
    ...
    app.state._olt_poller_task = start_olt_poller(app)
...
from olt_management import build_olt_router, start_olt_poller  # noqa: E402
...
api.include_router(build_olt_router(get_current_user, require_roles))
